...
class BigQueryClient:
    ...
    def __init__(self, project: str = None, use_live: bool = False, table: str = None):
        ...
        # The table can be provided directly or through the BQ_TABLE env var.
            ...
            for d in dates:
                ...
                class BigQueryClient:
                    ...
                    def __init__(self, project: str = None, use_live: bool = False, table: str = None):
                        ...
                        if use_live:
                            try:
                                ...
                                # Keep the exception for higher-level handling
                                raise RuntimeError("BigQuery client initialization failed: {}".format(e))
                    ...
                    def get_gke_costs_by_service(self, start_date: str, end_date: str) -> pd.DataFrame:
                        ...
                        # Determine the table to query. If no explicit table is provided, fall back
                        # to the historical default path used previously.
